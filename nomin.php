...
if(isset($_POST['Add']))
{
	...
	$qry="INSERT INTO committee (Name,Desg,Rank,Type,Photo) VALUES ('$name','$desg','$rank','N','$g')"; 
	$res=mysqli_query($connect,$qry)or die(mysqli_error($connect));
}
if(isset($_SESSION['log3']))
    ...
    $g="IMG_".$r.".".$ext;
        ...
        <input name="File" type="file" id="File" style="margin-top: 20px" required>
		<br>
		<center>
    ...
    <div class="row">
        <div class="col-lg-12">
            <table class="table table-bordered table-responsive">
                ...
                <tbody>
                <?php $qry="Select Sno,Name,Desg,Rank,Photo from committee where View='Y' AND Type='N' order by Rank"; 
						$res=mysqli_query($connect,$qry)or die(mysqli_error($connect));
						while($row=mysqli_fetch_assoc($res))
						{
							...
							<td><?php echo $i++; ?></td>
							<td><img  src='<?php echo "images/$row[Photo]"; ?>' style="margin:2px;margin-bottom:20px;" class="img" width="265px" height="190px"/></a></td>
