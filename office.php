...
if(isset($_POST['Add']))
{
	...
	$qry="INSERT INTO committee (Name,Desg,Rank,Type,Photo) VALUES ('$name','$desg','$rank','O','$g')"; 
	$res=mysqli_query($connect,$qry)or die(mysqli_error($connect));
}
    ...
    <div class="row">
        <div class="col-lg-12">
            <table class="table table-bordered table-responsive">
                ...
                <tbody>
                <?php $qry="Select Sno,Name,Desg,Rank,Photo from committee where View='Y' And Type='O' order by Rank"; 
						$res=mysqli_query($connect,$qry)or die(mysqli_error($connect));
