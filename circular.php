        ...
        <table>
         <thead>
          ...
          <th>Download</th>
            ...
            <?php
            $i=1;
             $ruleQuery="SELECT * FROM cir_gal_not WHERE Type='C' AND View='Y' ORDER BY Rank";
...
<?php }
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">Add Circulars
...
<?php
    ...
    $g="CIR_".$r.".".$ext;
        ...
        <form action="circular.php" method='post' enctype="multipart/form-data">
<div class="col-lg-8">
<label for="Data">Circular Name:</label>
...
<input name="File" type="File" id="File" name="File" style="margin-top: 20px" value="<?php echo $ruleRow['File'];?>" required> </div>  
...
if(isset($_POST['Data']))
{
    ...
    $c11="INSERT INTO cir_gal_not (Data,File,Type,Rank) VALUES ('$event','$g','C','$R')";
  

if(mysqli_query($connect,$c11))
{
 ?>
   <script> alert("New Circular Added Successfully");</script>
<?php   
}
else
{
...
if(isset($_POST['delete']))
{
    ...
    <div class="row">
        <div class="col-lg-12">
           <center><h1>Circulars</h1></center><hr>
           <div class="col-lg-10">                   
                     <div class="row">
                     <table id="myTable">
                     <tr>
            ...
            <?php
            $i=1;
             $ruleQuery="SELECT * FROM cir_gal_not WHERE Type='C' AND View='Y'";
            $ruleResult=mysqli_query($connect,$ruleQuery) or die();
