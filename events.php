    ...
    <div class="row">
        <div class="col-lg-12">
            <?php
			    $dat=date('Y-m-d');
            $i=1;
             $ruleQuery="Select * from student_branch order by inst_name";
            $ruleResult=mysqli_query($connect,$ruleQuery) or die();
            
            while($ruleRow=mysqli_fetch_assoc($ruleResult)){
                if($ruleRow['Added_By']==$_SESSION['id'])
                {
            	?>
              <div class="center" align="center">   <h2><b><u><?php echo $row['inst_name'] ?></u></b></h2> </div>
                <div class="col-lg-8">
...
<input name="events1" class="form-control" type="text" id="events" name="events" style="margin-top: 20px" value="<?php echo $ruleRow['eventName'];?>" required></div>
 <div class="col-lg-4">
<label for="rank">Rank:</label>
<input name="rank1" class="form-control" type="number" id="rank" name="rank" style="margin-top: 20px" value="<?php echo $ruleRow['Rank'];?>" required> </div>    
<br>
<br>
<hr>
<div class="col-lg-8">
<label for="fromdate">From Date:</label>
<input name="fromdate1" class="form-control" type="date" id="fromdate" name="fromdate" style="margin-top: 20px" value="<?php echo $ruleRow['from_date'];?>" required> </div>  
<div class="col-lg-4">
<label for="todate">To Date:</label>
<input name="todate1" class="form-control" type="date" id="todate" name="todate" style="margin-top: 20px" value="<?php echo $ruleRow['to_date'];?>" required></div>
<br>
<br>
<hr>
<label for="eventdetail1" >EventDetail1:</label>
<textarea name="eventdetail11" class="form-control" rows="2" cols="50" style="margin-top: 20px" required><?php echo $ruleRow['Eventdetail_1'];?></textarea>
    

<label for="eventdetail2">EventDetai2:</label>
<textarea name="eventdetail21" class="form-control" rows="2" cols="50" style="margin-top: 20px"><?php echo $ruleRow['Eventdetail_2'];?></textarea>
<br>
<br>
<hr>
<label for="eventdetail3">EventDetai3:</label>
    <textarea name="eventdetail31" class="form-control" rows="2" cols="50" style="margin-top: 20px"><?php echo $ruleRow['Eventdetail_3'];?></textarea>
    
    
<label for="eventdetail4">EventDetai4:</label>
    <textarea name="eventdetail41" class="form-control" rows="2" cols="50" style="margin-top: 20px"><?php echo $ruleRow['Eventdetail_4'];?></textarea>
    <br>
<br>
<hr>
<label for="eventdetail5">EventDetai5:</label>
    
    <textarea name="eventdetail51" class="form-control" rows="2" cols="50" style="margin-top: 20px"><?php echo $ruleRow['Eventdetail_5'];?></textarea>
<div id="lower">
<br>
<?php  }?>
